...
from haystack_integrations.document_stores.singlestore import SingleStoreDocumentStore
...
class ExampleRetriever:
    ...
    def __init__(self, document_store: SingleStoreDocumentStore, filters: Optional[Dict[str, Any]] = None, top_k: int = 10):
        """
