...
from src.haystack_integrations.document_stores.singlestore.document_store import SingleStoreDocumentStore
...
class TestSingleStoreDocumentStore(DocumentStoreBaseTests):
    ...
    @pytest.fixture
    def docstore(self, mock_connection):
    ...
    def test_count_documents(self, docstore, mock_connection):
    ...
    def test_filter_documents(self, docstore, mock_connection):
        mock_cursor = mock_connection.cursor.return_value
    ...
    def test_write_documents(self, docstore, mock_connection):
        mock_cursor = mock_connection.cursor.return_value
    ...
    def test_write_documents_duplicate(self, docstore, mock_connection):
        mock_cursor = mock_connection.cursor.return_value
    ...
    def test_delete_documents(self, docstore, mock_connection):
        mock_cursor = mock_connection.cursor.return_value
        mock_cursor.rowcount = 1
    ...
    def test_delete_documents_missing(self, docstore, mock_connection):
        mock_cursor = mock_connection.cursor.return_value
